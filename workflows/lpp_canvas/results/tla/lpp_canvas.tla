...
t_create_llm ==
    /\ state = "creating"
    /\ llm_enabled = TRUE /\ api_key /= NULL  \* gate: g_llm_enabled
    /\ state' = "llm_assist"
    /\ blueprint' = blueprint
    /\ blueprint_path' = blueprint_path
    /\ blueprint_json' = blueprint_json
...
t_select ==
    /\ state = "loaded"
    /\ selected_node /= NULL  \* gate: g_has_selection
    /\ state' = "editing"
    /\ blueprint' = blueprint
    /\ blueprint_path' = blueprint_path
    /\ blueprint_json' = blueprint_json
...
t_sim_step ==
    /\ state = "simulating"
    /\ sim_state /= NULL  \* gate: g_sim_not_terminal
    /\ sim_step_count < 1000  \* gate: g_sim_step_limit
    /\ sim_available_events /= NULL  \* gate: g_has_available_events
    /\ state' = "simulating"
    /\ blueprint' = blueprint
    /\ blueprint_path' = blueprint_path
    /\ blueprint_json' = blueprint_json
...
t_sim_reset ==
    /\ state = "simulating"
    /\ blueprint /= NULL  \* gate: g_has_blueprint
    /\ state' = "simulating"
    /\ blueprint' = blueprint
    /\ blueprint_path' = blueprint_path
    /\ blueprint_json' = blueprint_json
