--------------------------- MODULE py2lpp_extractor_proofs ---------------------------
(*
 * L++ Blueprint: Module Extractor
 * Version: 1.0.0
...
States == {STATE_idle, STATE_extracting, STATE_done, STATE_error}
