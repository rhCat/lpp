...
class Operator:
    ...
    def __init__(self, compute_registry: dict = None):
        self.context = {'_state': ENTRY_STATE, 'apiKey': None, 'apiBase': None, 'model': None, 'query': None, 'sources': None, 'searchResults': None, 'selectedPapers': None, 'paperDetails': None, 'paperLinks': None, 'conversation': None, 'synthesis': None, 'followUpQuestions': None, 'error': None}
