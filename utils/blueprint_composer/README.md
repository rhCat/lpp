...
stateDiagram-v2
    ...
    parent_loaded --> child_loaded: LOAD_CHILD
    child_loaded --> defining_embedding: DEFINE
    defining_embedding --> embedding_ready: DONE
    embedding_ready --> child_loaded: ADD_MORE
    embedding_ready --> composed: COMPOSE
    child_loaded --> composed: QUICK_COMPOSE
    composed --> validated: VALIDATE
