...
CONSTANTS
    STATE_idle, STATE_parsing, STATE_analyzing, STATE_inferring, STATE_generating, STATE_complete, STATE_error
...
ASSUME ConstantsDistinct ==
    ...
    /\ STATE_inferring /= STATE_complete
    /\ STATE_inferring /= STATE_error
...
States == {STATE_idle, STATE_parsing, STATE_analyzing, STATE_inferring, STATE_generating, STATE_complete, STATE_error}
TerminalStates == {}
