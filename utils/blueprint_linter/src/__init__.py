"""
COMPUTE units for L++ Blueprint Linter.

This package provides the computation functions for:
- lint: Linting operations (load, check rules, generate report)
"""

from .linter_compute import COMPUTE_REGISTRY as LINT_REGISTRY
import sys
