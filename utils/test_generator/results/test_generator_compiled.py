...
class Operator:
    ...
    def __init__(self, compute_registry: dict = None):
        self.context = {'_state': ENTRY_STATE, 'blueprint': None, 'blueprint_path': None, 'graph': None, 'paths': None, 'gate_analysis': None, 'path_tests': None, 'state_tests': None, 'gate_tests': None, 'negative_tests': None, 'property_tests': None, 'all_tests': None, 'output_format': None, 'output_path': None, 'formatted_output': None, 'coverage_report': None, 'error': None}
