"""
L++ Compiled Operator: Test Old Workflow
Version: 1.0.0
...
BLUEPRINT_ID = 'test_old_workflow'
BLUEPRINT_NAME = 'Test Old Workflow'
...
class Operator:
    """
    Compiled L++ Operator: Test Old Workflow
    """

    def __init__(self, compute_registry: dict = None):
        self.context = {'_state': ENTRY_STATE, 'status': None, 'data': None}
...
if __name__ == '__main__':
    print('L++ Compiled Operator: Test Old Workflow')
