...
DISPLAY_RULES = [
    ...
    {'gate': 'is_paused_state',
        'template': '[PAUSED] {blueprint_name} @ {debug_state} (step {history_index})'},
    {'gate': 'is_debugging',
        'template': '[DEBUG] {blueprint_name} @ {debug_state} (step {history_index})'},
    {'gate': 'is_inspecting',
        'template': '[INSPECT] {blueprint_name} @ {debug_state}'},
    {'gate': 'is_time_travel',
        'template': '[TIME-TRAVEL] {blueprint_name} @ step {history_index}'},
...
class Operator:
    ...
    def __init__(self, compute_registry: dict = None):
        self.context = {'_state': ENTRY_STATE, 'blueprint': None, 'blueprint_path': None, 'blueprint_name': None, 'blueprint_id': None, 'debug_state': None, 'debug_context': None, 'breakpoints': None, 'watches': None, 'watch_values': None, 'history': None,
                        'history_index': None, 'available_events': None, 'available_transitions': None, 'last_transition': None, 'last_gate_results': None, 'last_action_results': None, 'is_paused': None, 'hit_breakpoint': None, 'output': None, 'error': None}
