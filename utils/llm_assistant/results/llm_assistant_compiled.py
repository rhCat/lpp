...
class Operator:
    ...
    def __init__(self, compute_registry: dict = None):
        self.context = {'_state': ENTRY_STATE, 'api_key': None, 'api_base': None, 'model': None, 'schema_content': None, 'blueprint': None,
                        'blueprint_path': None, 'conversation': None, 'last_query': None, 'last_response': None, 'temperature': None, 'max_tokens': None, 'error': None}
