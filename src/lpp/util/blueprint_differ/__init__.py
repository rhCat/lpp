"""
L++ Blueprint Differ Utility

Semantic diff and merge tool for L++ blueprints
"""
...
def run(params: dict) -> dict:
    """Run the blueprint_differ utility with given parameters."""
    ...
    new_state, new_ctx, traces, err = run_frame(
        blueprint, context, "LOAD_LEFT", {}, COMPUTE_REGISTRY
    )
