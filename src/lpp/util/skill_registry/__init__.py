"""
L++ Skill Registry Utility

Scan and document L++ skills for agent blueprint generation
"""
...
def run(params: dict) -> dict:
    """Run the skill_registry utility with given parameters."""
    ...
    new_state, new_ctx, traces, err = run_frame(
        blueprint, context, "SCAN", {}, COMPUTE_REGISTRY
    )
