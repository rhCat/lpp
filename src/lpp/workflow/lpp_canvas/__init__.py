"""
L++ Lpp Canvas Workflow

Higher-assembly blueprint studio for creating, reviewing, auditing, simulating, and editing L++ blueprints with LLM assistance and interactive GUI
"""
...
def run(project_path: str = None, output_path: str = None, **options) -> dict:
    ...
    event = entry_events[0] if entry_events else "NEW"
