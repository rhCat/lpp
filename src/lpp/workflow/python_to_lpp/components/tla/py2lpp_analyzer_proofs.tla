--------------------------- MODULE py2lpp_analyzer_proofs ---------------------------
(*
 * L++ Blueprint: Python Code Analyzer
 * Version: 1.0.0
...
States == {STATE_idle, STATE_analyzing, STATE_done, STATE_error}
